...
namespace EventEase.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // 1. Seed EventTypes (New Lookup Table for Part 3)
            // It is best to seed this first so other tables can reference these IDs
            modelBuilder.Entity<EventType>().HasData(
                ...
                new EventType { EventTypeId = 4, TypeName = "Gala" }
            );

            // 2. Seed Venues
            modelBuilder.Entity<Venue>().HasData(
                new Venue { VenueId = 1, VenueName = "The Grand Ballroom", Location = "123 Marble Ave, Cape Town", Capacity = 500, ImageUrl = "https://images.unsplash.com/photo-1519167758481-83f550bb49b3?w=800", IsAvailable = true },
                new Venue { VenueId = 2, VenueName = "Sunset Garden", Location = "45 Ocean View, Durban", Capacity = 150, ImageUrl = "https://images.unsplash.com/photo-1523438885200-e635ba2c371e?w=800", IsAvailable = true },
                new Venue { VenueId = 3, VenueName = "Tech Hub Plaza", Location = "88 Innovation Dr, Sandton", Capacity = 1000, ImageUrl = "https://images.unsplash.com/photo-1497366216548-37526070297c?w=800", IsAvailable = true },
                new Venue { VenueId = 4, VenueName = "Cozy Corner Café", Location = "12 Main St, Pretoria", Capacity = 30, ImageUrl = "https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=800", IsAvailable = true }
            );
            ...
            modelBuilder.Entity<Event>().HasData(
                ...
                new Event
                {
                    ...
                    VenueId = 3,
                    EventTypeId = 2, // Linked to Conference
                ...
                new Event
                {
                    ...
                    VenueId = 2,
                    EventTypeId = 1, // Linked to Wedding
                    ImageUrl = "https://images.unsplash.com/photo-1519741497674-611481863552?q=80&w=1000"
                }
            );

            // 4. Seed Bookings (FIX: Added missing required fields)
            modelBuilder.Entity<Booking>().HasData(
                new Booking
                {
                    ...
                    EventId = 1,
                    VenueId = 1,
                    BookingDate = new DateTime(2026, 05, 10),
                    CustomerName = "Admin",
            ...
            // 5. Seed Staff with STATIC Hashed Passwords
